 ...
 *  - 프로그램 실행시 가장 먼저 메모리에 로드(Class load)
 *  
 *  싱글톤 객체(Singleton)
 *  - 싱글톤 패턴이 적용된 객체는 하나의 인스턴스(메모리 상에 생성된 객체)로 존재하는 객체
...
public class StaticTest {
	public static void main(String[] args) {
		...
		//싱글톤(Singleton) 객체 많이 쓰임!!!!!!!
		Calc cal = Calc.getInstance(); //외부에서 참조할수 있게 겟인스턴스로 객체 만듬
