...
public class MapTest {
	public static void main(String[] args) {
		...
		m1.put(101, new Apple("한국", 3000)); //사과 객체
		m1.put(102, new Apple("중국", 2000)); //사과 객체
		m1.put(103, new Apple("일국", 1000)); //사과 객체
		
		Map<Integer, Apple> m2 = new HashMap<>();
		m2.put(201, new Apple("미국", 3000)); //사과 객체
		m2.put(202, new Apple("영국", 2000)); //사과 객체
		m2.put(203, new Apple("호주", 1000)); //사과 객체
		
		Map<Integer, Apple> m3 = new HashMap<>();
		m3.put(301, new Apple("태국", 3000)); //사과 객체
		m3.put(302, new Apple("대만", 2000)); //사과 객체
		m3.put(303, new Apple("홍콩", 1000)); //사과 객체
